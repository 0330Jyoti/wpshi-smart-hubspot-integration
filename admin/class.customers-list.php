...
function usersFinalDatass($users_data)
  {
    return $users_data['data'];
  }

class Customers_Listss extends WP_List_Table{
    /** Class constructor */
    public function __construct(){
        parent::__construct(['singular'     => esc_html__('Customer', 'wpshi-smart-hubspot') , //singular name of the listed records
        'plural'                            => esc_html__('Customers', 'wpshi-smart-hubspot') , //plural name of the listed records
        'ajax'                              => true
    ...
    public function no_items(){
        echo esc_html__('No customers avaliable.', 'wpshi-smart-hubspot');
    }
    ...
    function column_action($item){
        $action = '<form action="" method="post">                      
                        ...
                        <button class="button" name="smart_synch" value="hubspot" type="submit">'.esc_html__('Sync', 'wpshi-smart-hubspot').'</button>
                </form>';
        return $action;
    }
    ...
    function get_columns(){
        $columns = [
                'ID'                  => esc_html__('Id', 'wpshi-smart-hubspot') , 
                'woocommerce_name'    => esc_html__('Name', 'wpshi-smart-hubspot') , 
                'user_email'          => esc_html__('Email', 'wpshi-smart-hubspot') , 
                'user_registered'     => esc_html__('Create Time', 'wpshi-smart-hubspot') , 
                'action'              => esc_html__('Action', 'wpshi-smart-hubspot') 
            ];
        return $columns;
    }
