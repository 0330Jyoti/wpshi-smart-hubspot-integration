...
<div class="wrap">                
	...
	<h1><?php echo esc_html__( 'Zoho CRM Settings and Authorization' ); ?></h1>
	<hr>
	...
	<form method="post">
		...
		<nav class="nav-tab-wrapper woo-nav-tab-wrapper">
			<a href="<?php echo admin_url('admin.php?page=wpszi-smart-zoho-integration&tab=general'); ?>" class="nav-tab <?php if($tab == 'general'){ echo 'nav-tab-active';} ?>"><?php echo esc_html__( 'General', 'wpszi-smart-zoho' ); ?></a>
			<a href="<?php echo admin_url('admin.php?page=wpszi-smart-zoho-integration&tab=synch_settings'); ?>" class="nav-tab <?php if($tab == 'synch_settings'){ echo 'nav-tab-active';} ?>"><?php echo esc_html__( 'Synch Settings', 'wpszi-smart-zoho' ); ?></a>
		</nav>
		...
		<?php if( isset($tab) && 'general' == $tab ){ ?>
			...
			<table class="form-table general_settings">
				<tbody>
					...
					<tr>
						<th scope="row">
							<label><?php echo esc_attr( 'Redirect URI', 'wpshi-smart-zoho' ); ?></label>
						</th>
						<td>
