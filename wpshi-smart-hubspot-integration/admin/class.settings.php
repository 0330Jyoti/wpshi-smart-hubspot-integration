        ...
        $client_id = $client_secret = "";
       	...
       	if ( isset( $_POST['submit'] ) ) {
            ...
            if ( $client_id && $client_secret ) {
                ...
                $redirect_url = "$wpshi_smart_hubspot_data_center/oauth/v2/auth?client_id=$client_id&redirect_uri=$redirect_uri&response_type=code&scope=ZohoCRM.modules.all,ZohoCRM.settings.all&access_type=offline";
